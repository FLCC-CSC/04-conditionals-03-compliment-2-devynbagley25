...
# NAME: Devyn Bagley
# DATE: 10/5/2025
# BRIEF DESCRIPTION:  The user is prompted if they want a compliment, if yes a compliment is given, otherwise another response is given.
...
def main():
    def compliment():
        would_you = input('Would you like a compliment? ')
